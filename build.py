...
"en": dict(
    ...
    ctanote="<strong>Try every feature free for 7 days.</strong> Then pay €7.99 once in Spain to unlock it for life. No subscription. No automatic charge.",
    ...
    pricenum="€7.99 in Spain", priceonce="One payment. Permanent full access.",
...
"es": dict(
    ...
    ctanote="Prueba todas las funciones gratis durante 7 días. <strong>Después, un solo pago de 7,99 € para desbloquearla para siempre.</strong> Sin suscripción ni cobro automático.",
...
"fr": dict(
    ...
    ctanote="Essaie toutes les fonctions gratuitement pendant 7 jours. <strong>Ensuite, un seul paiement de 7,99 € pour tout débloquer à vie.</strong> Aucun abonnement ni prélèvement automatique.",
...
"de": dict(
    ...
    ctanote="Teste alle Funktionen 7 Tage kostenlos. <strong>Danach schaltest du alles mit einer einmaligen Zahlung von 7,99 € dauerhaft frei.</strong> Kein Abo und keine automatische Abbuchung.",
...
"it": dict(
    ...
    ctanote="Prova tutte le funzioni gratis per 7 giorni. <strong>Poi sblocca tutto per sempre con un unico pagamento di 7,99 €.</strong> Nessun abbonamento né addebito automatico.",
...
"pt": dict(
    ...
    ctanote="Experimente todas as funcionalidades gratuitamente durante 7 dias. <strong>Depois, desbloqueie tudo para sempre com um único pagamento de 7,99 €.</strong> Sem subscrição nem cobrança automática.",
...
"tr": dict(
    ...
    ctanote="Tüm özellikleri 7 gün ücretsiz deneyin. <strong>Sonra 7,99 € tek seferlik ödeme ile her şeyi sonsuza kadar açın.</strong> Abonelik ve otomatik ücret yok.",
