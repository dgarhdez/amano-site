...
"en": dict(
    ...
    made="made by one person, with care", privacy="Privacy", terms="Terms", support="Support", review="Write a review", heroalt="The Amano vault on an iPhone", tagfree="Free for everyone", tagunl="Included with Unlimited", alsoh="Also in Amano", freeh="Start free", freep="Scan or import your first ten documents without paying anything.", store="App&nbsp;Store",
...
"es": dict(
    ...
    made="hecho por una persona, con cariño", privacy="Privacidad", terms="Condiciones", support="Ayuda", review="Escribe una reseña", heroalt="El espacio de Amano en un iPhone", tagfree="Gratis para todos", tagunl="Incluido en Unlimited", alsoh="Y además, en Amano", freeh="Empieza gratis", freep="Escanea o importa tus diez primeros documentos sin pagar nada.", store="App&nbsp;Store",
...
"fr": dict(
    ...
    made="fait par une seule personne, avec soin", privacy="Confidentialité", terms="Conditions", support="Assistance", review="Laisser un avis", heroalt="Le coffre Amano sur un iPhone", tagfree="Gratuit pour tous", tagunl="Inclus dans Unlimited", alsoh="Et aussi, dans Amano", freeh="Commence gratuitement", freep="Scanne ou importe tes dix premiers documents sans rien payer.", store="App&nbsp;Store",
...
"de": dict(
    ...
    made="von einer Person gemacht, mit Sorgfalt", privacy="Datenschutz", terms="Bedingungen", support="Support", review="Bewertung schreiben", heroalt="Der Amano-Bereich auf einem iPhone", tagfree="Für alle kostenlos", tagunl="In Unlimited enthalten", alsoh="Außerdem in Amano", freeh="Kostenlos starten", freep="Scanne oder importiere deine ersten zehn Dokumente, ohne etwas zu zahlen.", store="App&nbsp;Store",
...
"it": dict(
    ...
    made="fatto da una persona sola, con cura", privacy="Privacy", terms="Termini", support="Assistenza", review="Scrivi una recensione", heroalt="L’archivio Amano su un iPhone", tagfree="Gratis per tutti", tagunl="Incluso in Unlimited", alsoh="E inoltre, in Amano", freeh="Inizia gratis", freep="Scansiona o importa i tuoi primi dieci documenti senza pagare nulla.", store="App&nbsp;Store",
...
"pt": dict(
    ...
    made="feito por uma pessoa, com cuidado", privacy="Privacidade", terms="Termos", support="Suporte", review="Escrever uma avaliação", heroalt="O espaço do Amano num iPhone", tagfree="Grátis para todos", tagunl="Incluído no Unlimited", alsoh="E ainda, no Amano", freeh="Comece grátis", freep="Digitalize ou importe os seus primeiros dez documentos sem pagar nada.", store="App&nbsp;Store",
...
"tr": dict(
    ...
    made="tek kişi tarafından, özenle yapıldı", privacy="Gizlilik", terms="Koşullar", support="Destek", review="Değerlendirme yaz", heroalt="iPhone’da Amano kasası", tagfree="Herkese ücretsiz", tagunl="Unlimited’a dahil", alsoh="Ayrıca Amano’da", freeh="Ücretsiz başlayın", freep="İlk on belgenizi hiçbir ücret ödemeden tarayın veya içe aktarın.", store="App&nbsp;Store",
