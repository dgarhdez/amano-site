...
"en": dict(
    ...
    ctanote="<strong>Try every feature free for 7 days.</strong> Then unlock forever with one payment. No subscription. No automatic charge.",
    ...
    price="7 days free &middot; one payment to unlock forever &middot; no subscription",
    ...
    pricenum="", priceonce="One payment. Permanent full access.",
